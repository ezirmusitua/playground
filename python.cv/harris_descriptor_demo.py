...
harrisim1 = harris.compute_harris_response(img1)
filtered_coords1 = harris.get_harris_points(harrisim1, WID + 1)

d1 = harris.get_harris_descriptor(img, filtered_coords, WID)
d2 = harris.get_harris_descriptor(img1, filtered_coords1, WID)

print('Start Matching ... ')
matches = harris.match_harris_descriptor_twosided(d1, d2)
print('End Matching')
print('Start Plotting')
pylab.figure()
pylab.gray()
harris.plot_harris_matches(img, img1, filtered_coords, filtered_coords1, matches)
pylab.show()
print('All Set')
